...
export declare type FullConfig = Required<Config>;
...
export declare type RunWithConfig = SharedConfig & {
    tag?: string | string[];
};
...
declare type EnvDetectBeforeEach<TestArgs> = {} extends TestArgs ? EnvOptionalBeforeEach<TestArgs> : EnvBeforeEach<TestArgs>;
declare type OptionalEnv<TestArgs> = {} extends TestArgs ? Env<TestArgs> | void : Env<TestArgs>;
export declare type Env<TestArgs> = EnvDetectBeforeEach<TestArgs> & {
