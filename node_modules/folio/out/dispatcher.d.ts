...
export declare class Dispatcher {
    ...
    private _didRunGlobalSetup;
    _globalSetupResult: any;
    ...
    _runJob(worker: Worker, entry: DispatcherEntry): Promise<unknown>;
    _obtainWorker(entry: DispatcherEntry): Promise<Worker>;
    _notifyWorkerClaimer(): Promise<void>;
    _createWorker(entry: DispatcherEntry): Promise<Worker>;
    stop(): Promise<void>;
...
declare class Worker extends EventEmitter {
    ...
    init(entry: DispatcherEntry): Promise<void>;
    run(runPayload: RunPayload): void;
    stop(): void;
}
export {};
